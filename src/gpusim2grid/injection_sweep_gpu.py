...
It is a thin facade over :class:`InjectionSweepSolver`.
"""

from .injection_sweep import InjectionSweepSolver, _normalize_device
...
class InjectionSweepGPU:
    ...
    grid : lightsim2grid GridModel / LSGrid
        The grid whose base case is solved on the CPU.
    ...
    def __init__(self, grid, *, init_from_n_powerflow=True, precision="fp64",
        ...
        if use_bridge:
            ...
            self._inner = InjectionSweepSolver._wrap_session(
            ...
            self._inner = InjectionSweepSolver(
                d["Ybus"], vinit, d["Sbus"],
    ...
    @property
    def solver(self):
        """The underlying :class:`InjectionSweepSolver` (escape hatch)."""
        return self._inner
